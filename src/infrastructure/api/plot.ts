import { ApiPlotThreadsResponse, ApiStoryQuestionsResponse, ApiSetupResponse, ApiDeusExMachinaResponse, ApiPlotStructuralReportResponse, ApiThreadTimelineResponse, ApiDormantThreadsResponse, ApiEventDensityResponse, ApiSetupPayoffMap, ApiPlotDensityResponse, ApiPlotRhythmReportResponse, mapResult } from "@/data/types";
import { toDeusExMachinaResponse, toDormantThreadsResponse, toEventDensityResponse, toPlotDensityResponse, toPlotRhythmReportResponse, toPlotStructuralReportResponse, toPlotThreadsResponse, toSetupPayoffMap, toSetupResponse, toStoryQuestionsResponse, toThreadTimelineResponse } from "@/compatability/transformers";
