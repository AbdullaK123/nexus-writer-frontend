import { ApiContradictionResponse, ApiEntityFactResponse, ApiEntityTimelineResponse, ApiStoryFactCountsResponse, ApiWorldConsistencyReport, mapResult } from "@/data/types";
import { toContradictionResponse, toEntityFactResponse, toEntityTimelineResponse, toStoryFactCountsResponse, toWorldConsistencyReport } from "@/compatability/transformers";
