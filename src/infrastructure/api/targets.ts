import { ApiTargetResponse, CreateTargetRequest, Frequency, TargetResponse, UpdateTargetRequest, Result, ApiError, mapResult, Ok } from "@/data/types";
import fetchApi from "./client";
import {transformTarget} from "@/compatability/transformers";
