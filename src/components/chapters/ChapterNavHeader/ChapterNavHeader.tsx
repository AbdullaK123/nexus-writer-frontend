...
import { ChapterNavHeaderProps } from "./types"
import styles from './ChapterNavHeader.module.css'
import { useChapters } from "@/app/hooks/chapters/useChapters";
import React, { useEffect, useState, useCallback } from "react";
import { useShortcut } from "@/app/hooks/common/useShortcut"; // Import the new hook
...
export default function ChapterNavHeader({
    ...
    useEffect(() => {
        if (creationError) onShowErrorToast(`Failed to create chapter: ${creationError.message}`);
    }, [creationError, onShowErrorToast]);

    useEffect(() => {
        if (updateError) onShowErrorToast(`Failed to update chapter: ${updateError.message}`);
